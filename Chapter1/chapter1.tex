...
However, it differs in the alignment method used, as Eggertson opted for a $k$mer based extension model, with the objective not of producing alignments but rather allele observation counts that could be used in genotyping.
