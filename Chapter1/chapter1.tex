...
However, as long as the reference is used as a basis space for analysis, it will be impossible to develop coherent representations of all sequences in a given cohort.
...
But these approaches will not allow out of core analysis processes like those implemented in resequencing pipelines.
