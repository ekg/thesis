...
The authors attribute this lower performance to a number of factors related to the additional complexity caused by the larger sequence alphabet and reference space.

\cite{maciuca2016natural}
...
To find seeds globally, it uses an implementation of the generalized compressed suffix array (GCSA) \cite{siren2011indexing}, which generalizes the FM-index to sequence DAGs, and builds its index including common short SNPs and indels.
...
\subsubsection{Scalable implementations of pangenome alignment}
