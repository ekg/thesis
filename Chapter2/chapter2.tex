...
\caption[The \emph{dozeu} X-drop alignment algorithm]{
  ...
  %Each corresponds to a SIMD vector value obtained through evaluation of the accelerated DP fill algorithm on a CPU supporting the required vectorized instructions.
