...
\begin{figure}[htbp!]
\centering
\includegraphics[width=0.95\textwidth]{Chapter2/Figs/mapping_cactus_pacbio_aln_vizzy.pdf}
\caption[Alignment of a PacBio read to a yeast pangenome]{
  ...
  Red nodes contain initial MEM hits, while other nodes are colored when they were matched during local alignment.
