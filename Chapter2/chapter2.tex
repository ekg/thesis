...
\begin{figure}[htbp!]
\centering
\includegraphics[width=0.95\textwidth]{Chapter2/Figs/mapping_cactus_pacbio_aln_viz_tall.pdf}
\caption[Alignment of a PacBio read to a yeast pangenome]{
  ...
  Red nodes contain initial MEM hits, while other colors indicate nodes matched during alignment.
  (A) The nodes found in the best alignment are labeled in blue.
  (B) A much smaller secondary alignment is shown in magenta.
