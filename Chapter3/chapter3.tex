...
\begin{figure}[htbp!] 
  ...
  \caption[Comparing alignment to the linear reference and SGRP2]{
    ...
    Note that the $y$-axes in these histograms represent the stacking of the log-transformed groups, which ensures that the relative width of each group's band is not distrorted by its order in the plotting.
  }
