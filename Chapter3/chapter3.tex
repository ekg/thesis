...
\subsection{Inducing the assembly graph from the MHC}

To evaluate the performance of the {\tt seqwish} algorithm described in section \ref{sec:from_pairwise_alignments}, I applied it to the same sequences used in 
