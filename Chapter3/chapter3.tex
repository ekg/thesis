...
The resulting assembly graph is shown in figure \ref{fig:human_gut_microbiome}.
...
Presumably the two ends of dumbell-like main component of the graph (as in figure \ref{fig:human_gut_microbiome}) represent these phyla, with the connection between them generated by horizontal transfer of genes or spurious correlation due to recurrent $k$-mers in the assembly graph.
