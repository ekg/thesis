...
\begin{figure}[htbp!]
  ...
  \caption[Evaluating alignment to the \emph{E. coli} pangenome.]{
    ...
    Although the alignment rate of the input reads to the pangenome graph is in all cases is above 99.5\%, panel \ref{subfig:ecoli_realignment_vs_input} shows a significant correlation in this rate and the number of input reads from each strain used to construct the graph.
  }
