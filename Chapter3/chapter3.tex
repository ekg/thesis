...
\begin{figure}[htbp!]
  \centering
  \includegraphics[width=1.0\textwidth]{Chapter3/Figs/bwa_vs_vg_ancient_data_simulations_120218.pdf}
  \caption{
    ...
  }
...
\begin{comment}
Aligned data from the following studies using vg and bwa (-l1024 -q15 -n0.02). Filtered bam files with samtools view -q30 and removed duplicates with sambamba markups

• Schiffels et al., 2016 (Anglo-Saxons, Iron Age)
• Martiniano et al., 2016 (Anglo-Saxons, Iron Age, Roman)
• Damgaard et al., 2018 (High-coverage Yamnaya and Botai)
\end{comment}
...
% Chapter3/Figs/aDNA_downsampling.pdf
